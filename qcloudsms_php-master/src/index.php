...
// 短信应用SDK AppID
$appid =1400150592; // 1400开头

// 短信应用SDK AppKey
$appkey = "55509acd5f4f22290a2cf38711bd7eac";

// 需要发送短信的手机号码
$phoneNumbers = ["17858767719"];

// 短信模板ID，需要在短信应用中申请
$templateId = ["174298","210907"];  // NOTE: 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请

// 签名
$smsSign = "罗学成网站开发"; // NOTE: 这里的签名只是示例，请使用真实的已申请的签名，签名参数使用的是`签名内容`，而不是`签名ID`
...
try {
    ...
    $result = $ssender->send(0, "86", $phoneNumbers[0],
        "{5555}为您的登录验证码，请于{2}分钟内填写。如非本人操作，请忽略本短信。");
